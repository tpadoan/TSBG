        ...
        for m in moves(sub_turn, pos):
            S.append(
                (
                    ...
                    tuple(
                        (
                            m if j == sub_turn else pos[j]
                            for j in range(numDetectives + 1)
                        )
                    ),
                )
            )
                        ...
                        if i != j != k != i:
                            ...
                            for nt, ns, m in succ(t, s, (h, i, j, k)):
                                if s > 0:
                                    ...
                                    if V[nt][ns][m][0] > V[t][s][(h, i, j, k)][0] or (
                                        V[nt][ns][m][0] == 1
                                        and (
                                            V[nt][ns][m][1] < V[t][s][(h, i, j, k)][1]
                                            or (
                                                V[nt][ns][m][1]
                                                == V[t][s][(h, i, j, k)][1]
                                                and newDist < dist
                                    ...
                                    if V[nt][ns][m][0] < V[t][s][(h, i, j, k)][0] or (
                                        V[nt][ns][m][0] == V[t][s][(h, i, j, k)][0]
                                        and V[nt][ns][m][1] > V[t][s][(h, i, j, k)][1]
                                    ):
                                        V[t][s][(h, i, j, k)] = V[nt][ns][m]
                                        P[t][s][(h, i, j, k)] = m[s]
